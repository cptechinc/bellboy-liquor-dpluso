<div id="no-more-tables" class="form-group">
	<table class="table-condensed cf order-details numeric">
		<thead class="cf">
			<tr>
				<th>Item</th> <th class="numeric text-right">Price</th>
                <th class="numeric text-right">Qty</th>
                <th class="numeric text-right">Total</th>
				<th class="text-center">Rqst Date</th> <th>Warehouse</th>
				<th>
					<div class="row">
		...
		<tbody>
			...
			<?php foreach ($details as $detail) : ?>
				<tr class="cart-item">
					...
					<td data-title="Rqst Date"  class="text-center"><?= $detail->rshipdate; ?></td>
