            ...
            <div class="duplicable-item-list">
        		<div class="row duplicable-item">
        			...
        			<div class="col-sm-3 form-group">
        				...
        				<input type="text" name="case-qty[]" class="form-control input-sm qty">
        			</div>
                    <div class="col-sm-3 form-group">
        				<label for="">Bottle Qty</label>
        				<input type="text" name="bottle-qty[]" class="form-control input-sm qty">
        			</div>
        		</div>
        	</div>
